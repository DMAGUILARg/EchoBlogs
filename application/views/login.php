...
<body>
    ...
    <div class="container">
        <div class="img">
            <img src="<?php echo base_url('application/assets/img/imagen2.png'); ?>" alt="Echo Blogs Logo" />
        </div>
        <div class="login-content">
            ...
            <form id="loginForm" action="<?php echo base_url('auth/do_login'); ?>" method="POST" novalidate>
                <img class="logo" src="<?php echo base_url('application/assets/img/echo.png'); ?>"
                    alt="Echo Blogs Logo" />
                ...
                <div class="text-end">
                    <a class="link-gray" href="<?php echo base_url(); ?>">Regístrese Aquí</a>
                </div>
            </form>
        </div>
    </div>
